...
public class CountingPanel extends JPanel {
	...
	private void setupLayout() {
		...
		springLayout.putConstraint(SpringLayout.VERTICAL_CENTER, factButton, 0, SpringLayout.VERTICAL_CENTER,
				fibButton);
	...
	private void setupListeners() {
		this.factButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				textArea.append(countingFrame.getBaseController().transferFactorial(textField.getText()) + "\n");
				textArea.append(countingFrame.getBaseController().getTimer().toString());
				textField.setText("");
			}
		});
	}
